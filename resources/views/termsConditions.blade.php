...
@section('child')
    <div class="container mt-2 p-5 text-justify">
        <h5>Terms & Conditions</h5>
        <p class="text-justify">
            This Terms & Conditions is prepared by {{ env('APP_NAME') }} and whose registered address is Bogor (“We”) are
            committed to protecting and preserving the privacy of our visitors when visiting our site or communicating
            ...
            applicable indonesia Data Protection legislation and regulations. Please read the following carefully to
        ...
        <p class="text-justify">
            ...
            social media. This includes information you provide when you submit a contact/inquiry form. The information you
            give us may include but is not limited to, your name, address, e-mail address, and phone number.
        </p>
        ...
        <p class="text-justify">
            ...
            institutions and authorities unless required by law or other regulations.
        ...
        <h5>Your rights – access to your personal data</h5>
        ...
        request must be made in writing to [insert contact details]. We will provide your personal data to you within the
        ...
        Any changes we may make to our Terms & Conditions in the future will be posted on this page and, where appropriate,
        notified to you by e-mail. Please check back frequently to see any updates or changes to our Terms & Conditions.
        Contact
        Questions, comments, and requests regarding this Terms & Conditions are welcomed and should be addressed to [name and
