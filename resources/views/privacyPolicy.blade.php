...
@section('child')
    <div class="container mt-2 p-5 text-justify">
        ...
        <p class="text-justify">
            This Privacy Policy is prepared by {{ env('APP_NAME') }} and whose registered address is Bogor (“We”) are
        ...
        Contact
        Questions, comments, and requests regarding this privacy policy are welcomed and should be addressed to [name and
